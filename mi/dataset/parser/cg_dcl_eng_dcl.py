...
"""
@package mi.dataset.parser.cg_dcl_eng_dcl
...
class CgDclEngDclMsgCountsDataParticle(DataParticle):
    """
    Class for building a CgDclEngDclMsgCountsDataParticle
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("msg counts raw_data: %s", self.raw_data)
...
class CgDclEngDclMsgCountsRecoveredDataParticle(CgDclEngDclMsgCountsDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_MSG_COUNTS_RECOVERED


class CgDclEngDclMsgCountsTelemeteredDataParticle(CgDclEngDclMsgCountsDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_MSG_COUNTS_TELEMETERED


class CgDclEngDclCpuUptimeDataParticle(DataParticle):
    """
    Class for building a CgDclEngDclCpuUptimeDataParticle
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("cpu uptime raw_data: %s", self.raw_data)

        for key in self.raw_data.keys():

            if key == CgDclEngDclParserDataParticleKey.HEADER_TIMESTAMP:

                log.debug("Setting internal timestamp")
                self.set_internal_timestamp(
                    utilities.dcl_controller_timestamp_to_ntp_time(self.raw_data[key]))
...
class CgDclEngDclCpuUptimeRecoveredDataParticle(CgDclEngDclCpuUptimeDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_CPU_UPTIME_RECOVERED


class CgDclEngDclCpuUptimeTelemeteredDataParticle(CgDclEngDclCpuUptimeDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_CPU_UPTIME_TELEMETERED


class CgDclEngDclErrorDataParticle(DataParticle):
    """
    Class for building a CgDclEngDclErrorDataParticle
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("error raw_data: %s", self.raw_data)
...
class CgDclEngDclErrorRecoveredDataParticle(CgDclEngDclErrorDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_ERROR_RECOVERED


class CgDclEngDclErrorTelemeteredDataParticle(CgDclEngDclErrorDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_ERROR_TELEMETERED


class CgDclEngDclGpsDataParticle(DataParticle):
    """
    Class for building a CgDclEngDclGpsDataParticle
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("gps raw_data: %s", self.raw_data)
...
class CgDclEngDclGpsRecoveredDataParticle(CgDclEngDclGpsDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_GPS_RECOVERED


class CgDclEngDclGpsTelemeteredDataParticle(CgDclEngDclGpsDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_GPS_TELEMETERED


class CgDclEngDclPpsDataParticle(DataParticle):
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("pps raw_data: %s", self.raw_data)
...
class CgDclEngDclSupervDataParticle(DataParticle):
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("superv raw_data: %s", self.raw_data)
...
class CgDclEngDclDlogMgrDataParticle(DataParticle):
    """
    Class for building a CgDclEngDclDlogMgrDataParticle
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("dlog mgr raw_data: %s", self.raw_data)
...
class CgDclEngDclDlogMgrRecoveredDataParticle(CgDclEngDclDlogMgrDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_DLOG_MGR_RECOVERED


class CgDclEngDclDlogMgrTelemeteredDataParticle(CgDclEngDclDlogMgrDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_DLOG_MGR_TELEMETERED


class CgDclEngDclDlogStatusDataParticle(DataParticle):
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("dlog status raw_data: %s", self.raw_data)
...
class CgDclEngDclStatusDataParticle(DataParticle):
    """
...
class CgDclEngDclDlogAarmDataParticle(DataParticle):
    """
    Class for building a CgDclEngDclDlogAarmDataParticle
    """
    ...
    def _build_parsed_values(self):
        ...
        log.debug("dlog sea state raw_data: %s", self.raw_data)
...
class CgDclEngDclDlogAarmRecoveredDataParticle(CgDclEngDclDlogAarmDataParticle):

    _data_particle_type = CgDclEngDclDataParticleType.CG_DCL_ENG_DCL_DLOG_AARM_RECOVERED


class CgDclEngDclDlogAarmTelemeteredDataParticle(CgDclEngDclDlogAarmDataParticle):
...
class CgDclEngDclParser(SimpleParser):
    def __init__(self,
        ...
        try:
            ...
            self._msg_counts_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.MSG_COUNTS_PARTICLE_CLASS)
            self._cpu_uptime_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.CPU_UPTIME_PARTICLE_CLASS)
            self._error_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.ERROR_PARTICLE_CLASS)
            self._gps_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.GPS_PARTICLE_CLASS)
            self._pps_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.PPS_PARTICLE_CLASS)
            self._superv_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.SUPERV_PARTICLE_CLASS)
            self._dlog_mgr_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.DLOG_MGR_PARTICLE_CLASS)
            self._dlog_status_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.DLOG_STATUS_PARTICLE_CLASS)
            self._status_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.STATUS_PARTICLE_CLASS)
            self._dlog_aarm_particle_class = particle_classes_dict.get(
                CgDclEngDclParticleClassTypes.DLOG_AARM_PARTICLE_CLASS)

        except (KeyError, AttributeError):
            raise ConfigurationException("Invalid cg_dcl_eng_dcl configuration parameters.")
        ...
        while line:
            ...
            if re.match(MSG_LOG_TYPE_REGEX, line):
                ...
                if msg_counts_match is not None:
                    log.debug("msg_counts_match: %s", msg_counts_match.groupdict())
                    ...
                    log.debug("cpu_uptime_match: %s", cpu_uptime_match.groupdict())
                ...
                if error_match is not None:
                    log.debug("error_match: %s", error_match.groupdict())
                ...
                if gps_match is not None:
                    log.debug("gps_match: %s", gps_match.groupdict())
                    ...
                    log.debug("pps_match: %s", pps_match.groupdict())
                    ...
                    log.debug("superv_match: %s", superv_match.groupdict())
                    ...
                    log.debug("dlog_mgr_match: %s", dlog_mgr_match.groupdict())
                    ...
                    log.debug("dlog_status_match: %s", dlog_status_match.groupdict())
                    ...
                    log.debug("d_status_ntp_match: %s", d_status_ntp_match.groupdict())
                    ...
                    log.debug("sea_state_match: %s", dlog_aarm_match.groupdict())
